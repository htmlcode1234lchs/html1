function circlesineMain() {
	...
	s += '<div id="copyrt" style="font: 7pt arial; font-weight: bold; color: #6600cc; position:absolute; bottom:3px; left:1px; text-align:center;"></div>';
...
function incrAngle() {
	...
	//	clearInterval(id);
	//}
	//document.the_clock.the_time.value = frame + ", " + wait;
	update();
}
